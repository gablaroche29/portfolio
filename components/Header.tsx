    ...
    <header className="border-b border-text bg-bg sticky top-0 z-100 font-mono">
      <div className="mx-auto max-w-content px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <Link href="/" className="font-bold uppercase tracking-tighter text-lg">Gabriel_Laroche</Link>
        </div>/

        <nav className="hidden md:flex items-center h-full">
          <Link 
            href="/cv" 
            className="h-full px-6 flex items-center border-l border-text hover:bg-text hover:text-bg transition-colors duration-200 text-xs uppercase tracking-widest font-bold"
          >
            CV.pdf
          </Link>
